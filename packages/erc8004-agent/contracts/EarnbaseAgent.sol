...
/**
 * @title EarnbaseAgent
 * @notice The core identity registry for Earnbase agents.
 * @dev Implements ERC-721 for agent ownership and identity management.
 *      Agents are registered here to interact with the Earnbase Protocol.
 */
contract EarnbaseAgent is
    ...
    EIP712Upgradeable
{
    ...
    function initialize() public reinitializer(2) {
        ...
        __ERC721_init("EarnbaseAgent", "AGENT");
        __ERC721URIStorage_init();
        __EIP712_init("EarnbaseAgentRegistry", "1");
    }
