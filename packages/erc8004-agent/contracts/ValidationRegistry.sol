...
/**
 * @title EarnbaseValidationRegistry
 * @notice Manages validation requests and responses for agent tasks.
 * @dev Validators verify agent outputs and record results here.
 */
contract EarnbaseValidationRegistry is OwnableUpgradeable, UUPSUpgradeable {
