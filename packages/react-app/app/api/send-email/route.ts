  ...
  try {
    ...
    const htmlBody = `
      <div style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; max-width: 600px; margin: auto; padding: 24px; background: linear-gradient(to bottom, #F5F1E8, #FFFFFF); border: 4px solid #000000; border-radius: 16px;">
        <!-- Header -->
        <div style="background: #35D07F; color: white; padding: 24px; border-radius: 12px; margin-bottom: 24px; border: 4px solid #000000; text-align: center;">
        ...
        <!-- Footer -->
        <div style="text-align: center; margin: 24px 0; padding: 20px; background: #F5F1E8; border-radius: 12px; border: 4px solid #000000;">
          <p style="margin: 0; color: #000000; font-weight: bold; font-size: 16px;">
        ...
        <div style="border-top: 4px solid #000000; padding-top: 20px; margin-top: 24px; text-align: center; color: #666; font-size: 14px;">
          ...
          <p style="margin: 4px 0 0 0; font-size: 12px;">Connecting creators with participants through blockchain technology</p>
        </div>
      </div>
    `;
