              ...
              >
                ...
                <div className="flex items-center justify-between mt-2 border-t border-gray-100 pt-3">
                  ...
                  {task.restrictionsEnabled && !isVerified ? (
                    <div className="flex items-center gap-1 text-xs font-semibold text-celo-orange  px-3 py-1 rounded-full border border-celo-orange">
                      <Image src="/self-logo.png" alt="Self Logo" width={16} height={16} />
                      SELF VERIFICATION
                    </div>
                  ) : (
